...
const NavBar = () => {
  ...
  return (
    <div class="backgroundMain">
      <div class="px-4 py-5 mx-auto sm:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
              ...
              <ul class="flex items-center hidden space-x-8 lg:flex">
                <li>
                  <button 
                     ...
                     class="inline-flex items-center justify-center h-12 px-6 font-medum
                            ...
                            <ul class="space-y-4">
                              {menuList.map((el,i) =>(
                                 <li key={i+1}>
                                  <a 
                                    ...
                                    aria-label="Our product"
                                    title="Our Product"
                                    class="font-medum tracking-wide text-gray-700
                              ...
                              <li>
                                <a
                                  ...
                                  transaction duration-200 rounded shadow-md
                                  bg-deep-purple-accent-400 hover:bg-deep-purple-accent-700
