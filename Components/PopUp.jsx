             ...
             bg-white outline-none focus:outline-none'>
              {/*header*/}
                ...
                border-slate-200 rounded-t'>
                   ...
                   <button
                       className='p-l ml-auto bg-transparent border-0 text-black opacity-5
                    ...
                    >
                       <span className='bg-transparent text-black opacity-5 h-6 w-6 text-2xl
                         block outline-none focus:ouline-none'>
                          x
                         </span>
                    </button>
                </div>
                ...
                border-slate-200 rounded-b'>
                  <button
                    ...
                    <button
                    className='background text-white active:bg-emarald-600 font-bold
